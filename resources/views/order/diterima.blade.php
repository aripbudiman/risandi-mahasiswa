        ...
        <div class="p-4 md:p-5">
            <div class="flex flex-col justify-between items-center">
                <div class="flex justify-between w-full border-b">
                    ...
                    <div>
                        <span
                            class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-100 text-green-800">Sudah
                            diterima
                        </span>
                    </div>
                </div>
                ...
                <div class="py-3 px-4 text-sm text-gray-600 dark:text-gray-400 w-full">
                    <div class="w-full flex flex-col justify-center">
                        <p class="text-xl flex flex-col justify-center items-center w-full">
                            ...
                            <span class="text-hijau font-semibold">Diterima</span>
                        </p>
                    </div>
                    <dl class="mt-3">
                    ...
                    <p class="italic text-sm text-biru text-center mt-5">Pesanan sudah sampai</p>
                </div>
            </div>
        </a>
    </div>
