...
<div class="w-full bg-gray-100 pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
    <h1 class="text-3xl font-semibold text-gray-700">Kirim Paket</h1>
                ...
                <tr class="">
                    ...
                    <td class="whitespace-no-wrap hidden py-4 text-sm font-normal text-gray-500 sm:px-3 lg:table-cell">
                        <span
                            ...
                            Sedang dipacking</span>
                    </td>
                    <td class="whitespace-no-wrap hidden py-4 text-sm font-normal text-gray-500 sm:px-3 lg:table-cell">
                        <a href="{{ route('dashboard.proses_paket',$item->id) }}" type="submit"
                            class="py-1 px-2 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-800 text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm">
                            Proses
                        </a>
                    </td>
                </tr>
