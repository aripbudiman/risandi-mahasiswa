...
<div class="w-full bg-gray-100 pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
    <h1 class="text-3xl font-semibold text-gray-700">List Paket Sudah Diterima Customer</h1>
        ...
        <table class="min-w-full border-collapse border-spacing-y-2 border-spacing-x-2">
            <thead class="hidden border-b lg:table-header-group">
                <tr class="">
                    ...
                    <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-3">No Resi</td>
            ...
            <tbody class="bg-white lg:border-gray-300">
                ...
                <tr class="">
                    ...
                    <td
                        class="whitespace-no-wrap hidden py-4 text-left text-sm text-gray-600 sm:px-3 lg:table-cell lg:text-left">
                        <span
                            class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-blue-100 text-blue-800">{{ $item->no_resi }}</span>
                    </td>
